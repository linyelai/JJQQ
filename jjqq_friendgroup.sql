...
CREATE TABLE `friendgroup` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_pk` (`userId`),
  CONSTRAINT `user_pk` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `friendgroup` VALUES (1,'恋人',10000),(2,'朋友',10000);
...
-- Dump completed on 2018-11-20 20:47:59
